...
$pdf->AddPage(); 
// set the sourcefile 
$pdf->setSourceFile('../Doc/devis_ccam.pdf'); 
// import page 1 
$pdf->SetFontSize(9); 
...
$pdf->SetXY(39.3, 191.8); 
$pdf->Write(1, $TotalEuro ); 
...
$pdf->Output($Nom_Prenom . ' - Devis CEM CCAM.pdf', 'D');
?>