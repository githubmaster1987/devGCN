...
?>
	...
	<div id="content" align="center" style="padding-bottom:20px;background-image:url('images/bg_repeat.png'); background-repeat:repeat-y; width:806;">
		<table width="500" cellpadding="2" cellspacing="2">
			...
			<tr>
			<td><center><a href="administrationCRO.php" style="color:#5782af;text-decoration:none">Administration Modèle CRO</a></center></td>
			</tr>
			<tr>
			...
			<tr>
			<td><center><a href="administrationAideOperatoire.php" style="color:#5782af;text-decoration:none">Administration Aide Opératoire</a></center></td>
			</tr>
