...
//requete pour recuperer toutes les aides opératoires
$queryAideOpe = "SELECT * FROM Aide_Operatoire;";
$queryAideOpeResult = mysql_query($queryAideOpe);
while($sqldata = mysql_fetch_array($queryAideOpeResult)){
	$affiche[] = "<li><a style=\"color:#5782af;text-decoration:none;\" href = \"ficheAideOperatoire.php?IdAideOp=".$sqldata['IdAideOp']."\">".$sqldata['AideOperatoire']."</a></li>";
...
?>
	...
	<table width="500" cellpadding="0" cellspacing="0">
		...
		<tr height="120px">
	   		<td valign="top"><center><h3>Administration Aide Opératoire</h3></center></td>	
	   	</tr>
		<tr>
			<td>
				<fieldset>
				<legend><font style="color:#5782af;">Listes : </font></legend>
				<ul>
		...
		<tr height="50">
		<td><input type="button" value="Ajouter Aide Opératoire" onclick="document.location.href='ficheAideOperatoireVierge.php';"/></td>
		</tr>
